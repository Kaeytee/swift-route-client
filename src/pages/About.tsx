  ...
  return (
    <Layout title="About Us">
      <div className="p-4 md:p-6 bg-gray-100 dark:bg-gray-800 min-h-screen">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 dark:text-gray-100">About Our Company</h2>
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            Leading the way in logistics solutions since 2005.
          </p>
        </div>

        <div className="bg-white dark:bg-gray-800 p-6 rounded-md border dark:border-gray-700 shadow-sm mb-6">
          <h3 className="text-xl font-medium mb-4 dark:text-gray-100">Our Story</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-md border dark:border-gray-700 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-medium dark:text-gray-100">Our Mission</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-md border dark:border-gray-700 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-medium dark:text-gray-100">Our Vision</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-md border dark:border-gray-700 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-medium dark:text-gray-100">Global Reach</h3>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-md border dark:border-gray-700 shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-medium dark:text-gray-100">Our Team</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
